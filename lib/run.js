...
function install_deps() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.platform == 'darwin') {
            ...
            let runner0 = new toolrunner.ToolRunner('apt-get',
                ['update']);
            runner0.exec();
            let runner_ = new toolrunner.ToolRunner('apt-get',
                ['install', 'ruby-full', 'build-essential', 'postgresql', 'libpq-dev']);
           yield runner_.exec();
        }
        ...
        if (process.platform == 'darwin') {
            ...
            runner = new toolrunner.ToolRunner('',
